...
class MarketDataService {
  ...
  start() {
    ...
    this.fxuClient.on("connect", () => {
      ...
      // Statik ve Dinamik Veri kanallarını ayırıyoruz.

      this.fxuClient.subscribe("yerel/viop/fiyat");
      this.fxuClient.subscribe("yerel/viop/statik");
