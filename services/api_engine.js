...
class MeksaApi {
  ...
  async getViopFreeBalanceDetails() {
    ...
    return {
      ...
      tarih: fields[1] || null,
      teminatToplami: fields[4] || null,
      baslangicToplami: parseFloat(fields[7] || "0"),
      surdurmeToplami: parseFloat(fields[8] || "0"),
      serbesBakiye: parseFloat(fields[10] || "0"),
      kullanilabilirTeminat: parseFloat(fields[10] || "0"),
      cekilebilirTeminat: parseFloat(fields[11] || "0"),
